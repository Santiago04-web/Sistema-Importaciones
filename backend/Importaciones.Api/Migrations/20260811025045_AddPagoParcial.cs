...
{
    /// <inheritdoc />
    public partial class AddPagoParcial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagoParciales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PagoParciales_Pedidos_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagoParciales_PedidoId",
                table: "PagoParciales",
                column: "PedidoId");
        }
